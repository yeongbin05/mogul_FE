  ...
  return (
    <div>
      ...
      hover:bg-black bg-transparent text-black font-semibold hover:text-yellow-600 py-4 px-8   cursor-pointer m-5 "
        ...
        <div onClick={() => postAllClick()} className="font-bold p-4 px-6 m-4">
          더보기
        </div>
      </div>
      <div>
            ...
            if (d.registeredDate && d.user && d.user.nickname) {
              ...
              return (
                <div
                  ...
                  hover:bg-black bg-transparent text-black font-semibold hover:text-yellow-600 py-3.5 px-6  cursor-pointer mr-5 ml-5 mb-5"
                  style={{ backgroundColor: "#DED0B6" }}
                  key={index}
